...
U_NP,              U_NP,              U_LT(U_MEDIA, ESC),U_LT(U_NAV, SPACE),U_LT(U_MOUSE, TAB),U_LT(U_NUM, BSPC),  U_LT(U_SYM, RET), U_LT(U_FUN, DEL),  U_NP,              U_NP

// Extra layer
// A hack to make an optimized Cyrillic layout
...
#ifdef MIRYOKU_KEYBOARD_MIRYOKU_XIAO
